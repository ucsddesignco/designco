export const events = [
...

  {
    ...
    time: 1830,
    location: 'DIB 208',
    description: `Embark on a journey from design to deployment with Triton Software Engineering and Design Co 🚀!`,
  },

  {
    ...
    time: 1830,
    location: 'DIB 208',
    description: `Starting to stress about what life post-grad might look like with a Cognitive Science - Design degree? Never fear, Design Co is here!`,
  },

  {
    ...
    time: 1830,
    location: 'DIB 208',
    description: `Get ready for a night of creativity and connection at Design Co's social with Women in Computing! Add some ✨charm✨ to your phone and your evening at our Phone Charm Craft social.`,
  },
...
Join us for Design Co's Time Capsule Social on Wednesday, 5/22 at 6:30 PM in DIB 208. Take a break from the quarter-system grind — reflect on the year, write letters to your future self, and enjoy a chill study jam with friends! See you there!`,
...

  {
    ...
    description: `Celebrate the end of a sweet year with Design Co at Handel's in La Jolla Village! 🍨`,
  },

  {
    ...
    time: 1830,
    location: 'DIB 208',
    description: `Long time no see! Join Design Co on Wednesday 10/02 at 6:30 PM in DIB 208 for our Fall Kickoff.`,
    slidelink: 'https://www.figma.com/deck/yArT7aME47Hv0vhd8Vfa0j/GBM-%231%3A-Fall-Kickoff-2024'
  },

  {
    ...
    time: 1830,
    location: 'DIB 208',
    description: `Stick with Design Co next Wednesday night at our Slime-Making Soiree! Whether you’re here to build community or to relive your 2016 slime days, we can’t wait to hangout on Wednesday, 10/9 at 6:30 PM in DIB 202/208.`,
  },
];
