export const roles = [
  {
    ...
    a1: "Besides strengthening my technical skills, I’ve gained so many close friends who share the same interests as me and are devoted to progressing their careers alongside everyone else.",
    q2: "How have you grown during your time on the Design Co board?",
    a2: "I’ve grown to be a more confident leader and designer with the support from the Design Co board and our design community. ",
    q3: "How would you describe how the Design Co board works together?",
    a3: "Design Co’s work environment is very flexible. We are all busy because of school, but can count on everyone on the team to come together to get things done.",
    q4: "Fun fact?",
  ...
  },
  {
    ...
    offer: 
      ...
      &lt;li&gt; Familiar with front-end frameworks + tools (e.g. React, Angular, Vue.js, Sass, Gulp, etc.) &lt;/li&gt; \
      &lt;li&gt; Familiar with table-less responsive design and Bootstrap &lt;/li&gt; \
      &lt;li&gt; Knowledge of UX best practices &lt;/li&gt; &lt;/ol&gt;",
    ec: 
      "&lt;ol&gt; &lt;li&gt; Knowledge of visual design and brand/design systems &lt;/li&gt; \
    ...
    a1: "As a developer, I've learnt the unique but critical skill of collaborating with designers and believing in the process.",
    q2: "What have you learned from being on the Design Co board?",
    a2: 'That nobody is "good at design" or "completely knows design". It\'s an extremely fluid field and there\'s ALWAYS room to learn and grow. All you need is a team of passionate individuals rooting for you!',
    q3: "How would you describe how the Design Co board works together?",
    a3: "Respectful. There is room for collaboration, improvement, laughter and memories but in everything, each board member respects your opinion and makes your voice heard.",
    q4: "Fun fact?",
    a4: "I avoid serif fonts like the plague &lt;i&gt;(our designers are checking on Paridhi about this)&lt;/i&gt;"
  },
  {
    ...
    offer: 
      ...
      &lt;li&gt; Knowledge of design thinking and the human-centered design process &lt;/li&gt; &lt;/ol&gt;",
    ec: 
      "&lt;ol&gt; &lt;li&gt; Prior experience securing and maintaining industry partnerships &lt;/li&gt; \
    ...
    a1: "I want to create opportunities for the design community because I know how difficult it is doing it alone; rather than that I’d like for everyone to come and learn together.",
    q2: "What have you learned from being on the Design Co board?",
    a2: "I’ve learned what it means to have balance; doing cool sh*t while having fun. To epitomize my time on board it’s being surrounded with talented and really nice people.",
    q3: "How would you describe how the Design Co board works together?",
    a3: "An efficient and light-hearted way of organizing a bunch of moving pieces into really awesome events and opportunities. I’m extremely proud to be a part of the board and love the way we work. There doesn’t need to be a high stress environment to do good and have fun.",
    q4: "Fun fact?",
  ...
  },
  {
    ...
    description: "You are sociable and motivated. You are excited to help Design Co grow as a pre-professional organization and better support student designers. At Design Co, we believe that fostering an inclusive design community means collaborating with others and growing with everyone.",
    duty: 
    ...
    offer: 
      ...
      &lt;li&gt; Knowledge of design thinking and the human-centered design process &lt;/li&gt; &lt;/ol&gt;",
    ec: 
      "&lt;ol&gt; &lt;li&gt; Proficient knowledge in completing TAP forms, reserving spaces through OneStop & applying for AS funding &lt;/li&gt; \
    ...
    name: "Stella",
    q1: "What have you gained from being part of the Design Co board?",
    a1: "Something unexpected that I gained from being on board is the intimate community of designers that really inspired me to be more productive towards forwarding my design career. Everyone on board is passionate about what they do, and this is one of the first orgs, I've encountered, where I've truly felt like I've gained something from the hard work I've put into it, which I think is really rare and special.",
    q2: "How would you describe how the Design Co board works together?",
    a2: "We are all still learning things about the most ideal way to work together, but I find that we all make sure to have fun when we do it. All of us are conscious of what we can do to improve the team as a whole, and we are all learning to rely on one another.",
    q3: "Favorite color?",
    a3: "Yellow!",
  },
  {
    ...
    duty: 
      ...
      &lt;li&gt; Planning, writing, and executing articles our Medium publication (e.g. Alumni Spotlight) &lt;/li&gt; \
      &lt;li&gt; Creating, establishing, and iterating our content and writing guidelines &lt;/li&gt; \
      &lt;li&gt; Working with our Creative Team to ensure that our written language, and tone of voice, aligns with our visual language &lt;/li&gt; &lt;/ol&gt;"
    , 
    general: 
      "&lt;ol&gt; &lt;li&gt; Take the initiative to prepare and lead one or more GBMs per quarter, either on your own, or in collaboration with another board member or others in the design community &lt;/li&gt; \
      &lt;li&gt; Attend weekly GBMs, board meetings, large scale events, and other Industry Relations Team functions (~7 to 10 hours per week) &lt;/li&gt; \
    ...
    ,
    ec:
      "&lt;ol&gt; &lt;li&gt; Prior experience with writing copy and creating content for an organization or publication &lt;/li&gt; \
  ...
  },
  {
    ...
    description: "You love social media. You want to create an online presence for Design Co. You are the master of all influencers.",
    duty:
      "&lt;ol&gt; &lt;li&gt; Working in collaboration with the entire marketing team, curate, and execute marketing campaigns &lt;/li&gt; \
      &lt;li&gt; Helping the marketing team determine quarterly and year-long marketing strategies that increase reach, engagement, and impressions &lt;/li&gt; \
      &lt;li&gt; Managing our social media channels (Facebook, Instagram, LinkedIn, Snapchat) and ensuring a consistent flow of media posts &lt;/li&gt; \
    ...
    ,
    offer: 
      "&lt;ol&gt; &lt;li&gt; Experience using social media platforms &lt;/li&gt; \
    ...
    ec: 
      "&lt;ol&gt; &lt;li&gt; Prior experience developing a marketing plan for small to large scaled events &lt;/li&gt; \
