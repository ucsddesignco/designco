export const roles = [
  ...
  },
  {
    ...
    a1:
      "I’ve learned so much being on the Creative Team – I’ve worked on updating our very own community page and the main website. I’ve been equipped with knowledge in multiple programming languages and this has helped me understand the limitations of some frameworks, and the potential of implementing new technologies to create better experiences for users.",
    q2: "What have you learned from being on the Design Co board?",
    a2:
      "There’s so many moving components that goes on behind the scenes in creating an event or preparing for a workshop. Before joining Design Co, I looked forward to every single event hosted because of how engaging and how well those events were planned; now I clearly see why those events are AMAZING.",
    q3: "How would you describe how the Design Co board works together?",
    a3:
  ...
  },
  {
    ...
    q1: "What have you gained from being part of the Design Co board?",
    a1:
      "Through connecting with different industry professionals and leading design co gbm's I've gained a lot of confidence in myself as a designer and student leader on campus. Design Co board is a great way to gain a lot of new friends and an awesome support system!",
    q2: "How have you grown during your time on the Design Co board?",
    a2:
      "I used to be nervous about things like networking and speaking with professional designers. However, during my time as a industry relations coordinator on board, I've definitely grown to be more confident in my ability to connect with others!",
    q3: "How would you describe how the Design Co board works together?",
    a3:
  ...
  },
  {
    ...
    q1: "What have you gained from being part of the Design Co board?",
    a1:
      "I’ve been introduced to a group of people on board that are genuinely always willing to help, whether that’s design-related, for classes, or life in general. I have also learned what really goes into putting together these large scale events and initiatives, and am continually impressed by how we can come together and make these come to life.",
    q2: "How have you grown during your time on the Design Co board?",
    a2:
      "Imposter syndrome is something a lot of us deal with while growing as designers, but I’ve learned that growth is hard to see when you’re constantly thinking about how to improve in your day-to-day. Looking back, I’ve improved in confidence when leading workshops and during 1:1 interactions because I know that my insights can always be of help, if not at least relatable!",
    q3: "How would you describe how the Design Co board works together?",
    a3:
      "Everyone brings a different perspective and skill set to the table, and when we’re in the thick of brainstorming our next initiative, we consider everyone’s ideas. We also place a lot of trust in each other; you definitely won’t be micromanaged if you join us. Each team is their own powerhouse, but there’s always opportunities to explore work beyond what your role normally does too.",
    q4: "Fun fact?",
  ...
  },
  {
    ...
    duty:
      "&lt;ol&gt; &lt;li&gt; Working closely with all teams in Design Co to help kickstart initiatives that may require advanced logistics &lt;/li&gt; \
