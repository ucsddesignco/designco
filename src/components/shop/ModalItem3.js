                    ...
                    <div className="me">
                        <Grid container className="me-container">
                            ...
                            <Grid item xs={12} sm={6} md={6} lg={6} className="me-right">
                                ...
                                <p id="m1-5b" className="smaller-text">Every designer has their own story. It is time to create yours.</p>
                                <p id="m1-5b" className="smaller-text">Designed by Design Co Creative Team</p>
                                <p className="smaller-text">Models in Order of Photos:</p>
                                <p id="m1-5b" className="smaller-text">Juna: 5'3" - M, Julie: 5'5" - L, Adam: 6'0" - M, Maria: 5'7" - M, Jamin: 5'10" - L</p>
