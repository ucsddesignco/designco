...
class ListItemBuilder {
  ...
  serialize() {
    ...
    var listChild = child instanceof _Component.ComponentBuilder || child instanceof _DocumentList.DocumentListBuilder || child instanceof _List.ListBuilder || child instanceof _Editor.EditorBuilder ? child.serialize(serializeOptions) : child; // In the case of a function, create a bound version that will pass the correct serialize
