...
_temp = _class = class DeskTool extends _react.default.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "maybeAddEditorPane", (panes, props) => {
      ...
      var _router$state = router.state,
          ...
          _router$state$params = _router$state.params,
          params = _router$state$params === void 0 ? {} : _router$state$params;

      var template = params.template,
          templateParams = _objectWithoutProperties(params, ["template"]);
    ...
    _defineProperty(this, "shouldDerivePanes", nextProps => {
      ...
      return !(0, _isEqual2.default)(nextRouterState.panes, prevRouterState.panes) || nextRouterState.editDocumentId !== prevRouterState.editDocumentId || nextRouterState.legacyEditDocumentId !== prevRouterState.legacyEditDocumentId || nextRouterState.type !== prevRouterState.type || nextRouterState.action !== prevRouterState.action;
    });
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    if (this.shouldDerivePanes(nextProps)) {
      ...
      var diffAt = nextPanes.findIndex((id, index) => !prevPanes[index] || prevPanes[index].id !== id);
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return !(0, _shallowEquals.default)(oldProps, newProps) || !(0, _isEqual2.default)(oldPanes, newPanes) || !(0, _shallowEquals.default)(oldState, newState);
  }
  ...
  render() {
    ...
    var routerPanes = this.props.router.state.panes || [];
    var keys = routerPanes.map(pane => pane.id) || this.getFallbackKeys();
