...
class Pane extends _react.default.Component {
  constructor(props) {
    super(props); // Passed to rendered <Menu> components. This prevents the "click outside"
    ...
    _defineProperty(this, "handleCloseTemplateSelection", () => {
      this.setState({
        templateSelectionIsOpen: false
      });
    });
    ...
    _defineProperty(this, "renderActionMenuItem", item => {
      ...
      return _react.default.createElement(_router.IntentLink, {
        ...
        intent: "create",
        params: params
      }, _react.default.createElement("div", null, _react.default.createElement("div", null, item.title), _react.default.createElement("div", {
        className: styles.initialValueTemplateSubtitle
      }, params.type)), _react.default.createElement("div", {
        className: styles.initialValueTemplateDropDownItemIcon
      }, _react.default.createElement(Icon, null)));
    });
    ...
    _defineProperty(this, "renderAction", (action, i) => {
      ...
      return _react.default.createElement("div", {
        ...
        key: getActionKey(action, i)
      }, action.action !== 'toggleTemplateSelectionMenu' && _react.default.createElement("button", {
        className: styles.actionButton,
        ...
        className: styles.actionButtonInner,
        tabIndex: -1
      }, _react.default.createElement(Icon, null))), action.action === 'toggleTemplateSelectionMenu' && _react.default.createElement("div", {
        className: styles.initialValueTemplateDropDownMenuButton
      }, _react.default.createElement(_dropdown.default, {
        bleed: true,
        className: styles.initialValueTemplateDropDownMenu,
        items: items,
        renderItem: this.renderActionMenuItem // eslint-disable-next-line react/jsx-no-bind
        ,
  ...
  render() {
    var _this$props5 = this.props,
        ...
        staticContent = _this$props5.staticContent,
        contentMaxWidth = _this$props5.contentMaxWidth;
