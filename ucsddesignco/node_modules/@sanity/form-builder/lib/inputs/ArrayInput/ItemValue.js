...
class RenderItemValue extends _react.default.Component {
  ...
  renderEditItemForm(item) {
    ...
    if (options.editModal === 'fold') {
      return _react.default.createElement("div", null, _react.default.createElement(_fold.default, {
        title: title,
        onClose: this.handleEditStop
      }, content));
    }
    ...
    }, _react.default.createElement("div", null, _react.default.createElement(_content.default, {
      size: "medium"
    }, content)));
  }
  ...
  renderItem() {
    ...
    }, _react.default.createElement("div", null, _react.default.createElement(_status.default, {
