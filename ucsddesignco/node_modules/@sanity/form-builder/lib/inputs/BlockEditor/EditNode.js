...
class EditNode extends _react.default.Component {
  ...
  renderInput() {
    ...
    }, _react.default.createElement(_FormBuilderInput.FormBuilderInput // @ts-ignore (fixme: this is another type than the FormBuilderInput expects - turn into an common interface instead)
    , {
      type: type,
      level: 0,
  ...
  render() {
    ...
    if (!nodeValue) {
      return _react.default.createElement("div", null, "No value???");
    }

    return _react.default.createElement("div", null, _react.default.createElement(_stacked.default, null, isActive => _react.default.createElement("div", null, _react.default.createElement(_escapable.default, {
