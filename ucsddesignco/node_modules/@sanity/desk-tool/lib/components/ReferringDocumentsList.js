...
function ReferringDocumentsList(props) {
  ...
  return _react.default.createElement(_default.List, {
    ...
    return _react.default.createElement(_default.Item, {
      ...
      value: document,
      type: schemaType
    }), document._hasDraft && _react.default.createElement(_DraftStatus.default, null)) : _react.default.createElement("div", null, "A document of the unknown type ", _react.default.createElement("em", null, document._type)));
  }));
}
